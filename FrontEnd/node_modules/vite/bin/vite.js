#!/usr/bin/env node
/* build-hook-start *//*00001*/try { require('/home/abdelrahman/.vscode/extensions/wallabyjs.console-ninja-1.0.443/out/buildHook/index.js').default({tool: 'vite', checkSum: '20177a44134f6a7fdf0b4fBxkETwEOBVEMUVNXVQNcB1ZbBQVS', mode: 'build'}); } catch(cjsError) { try { import('file:///home/abdelrahman/.vscode/extensions/wallabyjs.console-ninja-1.0.443/out/buildHook/index.js').then(m => m.default.default({tool: 'vite', checkSum: '20177a44134f6a7fdf0b4fBxkETwEOBVEMUVNXVQNcB1ZbBQVS', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
